...
/*   Updated: 2024/01/21 12:50:41 by bebrandt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	vars.win_ptr = mlx_new_window(vars.mlx_ptr, 500, 500, "Heyllo world!");
	...
	mlx_hook(vars.win_ptr, 7, 1L << 4, mouse_enter_hook, &vars);
	mlx_hook(vars.win_ptr, 8, 1L << 5, mouse_exit_hook, &vars);
